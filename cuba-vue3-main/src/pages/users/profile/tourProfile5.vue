          ...
          <div class="profile-img-style">
            ...
            <div class="row">
              <div class="col-lg-12 col-xl-4">
                <div id="aniimated-thumbnials-3"><a href="javascript:void(0)"><img class="img-fluid rounded" src="@/assets/images/blog/img.png" alt="gallery"></a></div>
                <div class="like-comment mt-4 like-comment-lg-mb">
                  <ul class="list-inline">
                    <li class="list-inline-item border-right pe-3">
                      <label class="m-0"><a href="#"><i class="fa fa-heart"></i></a>  Like</label><span class="ms-2 counter"><number class="bold counter" ref="number1" :from="0" :to="2659" :duration="5" :delay="0"
                        easing="Power1.easeOut" /></span>
                    </li>
                    <li class="list-inline-item ms-2">
                      <label class="m-0"><a href="#"><i class="fa fa-comment"></i></a>  Comment</label><span class="ms-2 counter"><number class="bold counter" ref="number1" :from="0" :to="569" :duration="5" :delay="0"
                        easing="Power1.easeOut" /></span>
                    </li>
                  </ul>
                </div>
