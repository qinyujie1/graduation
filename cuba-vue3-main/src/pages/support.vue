            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="table-responsive">
                    <div id="basic-6_wrapper" class="dataTables_wrapper"><div class="dataTables_length" id="basic-6_length"><label>Show <select name="basic-6_length" aria-controls="basic-6" class=""><option value="10">10</option><option value="25">25</option><option value="50">50</option><option value="100">100</option></select> entries</label></div><div id="basic-6_filter" class="dataTables_filter"><label>Search:<input type="search" class="" placeholder="" aria-controls="basic-6" data-bs-original-title="" title=""></label></div><table class="display dataTable" id="basic-6" role="grid" aria-describedby="basic-6_info" style="width: 1443px;">
                      <thead>
                        <tr role="row"><th rowspan="2" class="sorting_asc" tabindex="0" aria-controls="basic-6" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column descending" style="width: 247px;">Name</th><th colspan="2" rowspan="1">HR Information</th><th colspan="4" rowspan="1">Contact</th></tr>
                        <tr role="row"><th class="sorting" tabindex="0" aria-controls="basic-6" rowspan="1" colspan="1" aria-label="Position: activate to sort column ascending" style="width: 279px;">Position</th><th class="sorting" tabindex="0" aria-controls="basic-6" rowspan="1" colspan="1" aria-label="Salary: activate to sort column ascending" style="width: 86px;">Salary</th><th class="sorting" tabindex="0" aria-controls="basic-6" rowspan="1" colspan="1" aria-label="Office: activate to sort column ascending" style="width: 134px;">Office</th><th class="sorting" tabindex="0" aria-controls="basic-6" rowspan="1" colspan="1" aria-label="Skill: activate to sort column ascending" style="width: 66px;">Skill</th><th class="sorting" tabindex="0" aria-controls="basic-6" rowspan="1" colspan="1" aria-label="Extn.: activate to sort column ascending" style="width: 74px;">Extn.</th><th class="sorting" tabindex="0" aria-controls="basic-6" rowspan="1" colspan="1" aria-label="E-mail: activate to sort column ascending" style="width: 263px;">E-mail</th></tr>
                      </thead>
                      <tbody>
                      <tr role="row" class="odd">
                          ...
                          <td class="sorting_1">
                            <div class="media"><img class="rounded-circle img-30 me-3" src="../assets/images/user/11.png" alt="Generic placeholder image">
                              <div class="media-body align-self-center">
                          ...
                          <td class="sorting_1">
                            <div class="media"><img class="rounded-circle img-30 me-3" src="../assets/images/user/9.jpg" alt="Generic placeholder image">
                              <div class="media-body align-self-center">
                          ...
                          <td class="sorting_1">
                            <div class="media"><img class="rounded-circle img-30 me-3" src="../assets/images/user/8.jpg" alt="Generic placeholder image">
                              <div class="media-body align-self-center">
                                <div>Dai Rios</div>
                              </div>
                            </div>
                      ...
                      <tfoot>
                        <tr><th rowspan="1" colspan="1">Name</th><th rowspan="1" colspan="1">Position</th><th rowspan="1" colspan="1">Salary</th><th rowspan="1" colspan="1">Office</th><th rowspan="1" colspan="1">Skill</th><th rowspan="1" colspan="1">Extn.</th><th rowspan="1" colspan="1">E-mail</th></tr>
                      </tfoot>
                    </table><div class="dataTables_info" id="basic-6_info" role="status" aria-live="polite">Showing 1 to 10 of 23 entries</div><div class="dataTables_paginate paging_simple_numbers" id="basic-6_paginate"><a class="paginate_button previous disabled" aria-controls="basic-6" data-dt-idx="0" tabindex="0" id="basic-6_previous">Previous</a><span><a class="paginate_button current" aria-controls="basic-6" data-dt-idx="1" tabindex="0">1</a><a class="paginate_button " aria-controls="basic-6" data-dt-idx="2" tabindex="0">2</a><a class="paginate_button " aria-controls="basic-6" data-dt-idx="3" tabindex="0">3</a></span><a class="paginate_button next" aria-controls="basic-6" data-dt-idx="4" tabindex="0" id="basic-6_next">Next</a></div></div>
                  </div>
              </div>
            </div>
          </div>
