        ...
        <el-menu active-text-color="#ccc" text-color="#fff" default-active="2" class="el-menu-vertical-demo">
          <router-link to="/admindashboards">
            <el-menu-item index="1" v-bind:style="{ color: activeIndex === 1 ? 'black' : 'white' }"
              ...
              <span style="padding-left: 60px" class="font1">总览</span>
...
/* 在线链接服务仅供平台体验和调试使用，平台不承诺服务的稳定性，企业客户需下载字体包自行发布使用并做好备份。 */
@font-face {
  font-family: "cloth_icon1";font-weight: 400;src: url("//at.alicdn.com/wf/webfont/h2kiuecLB7qy/Gzfi8ldp3Qij.woff2") format("woff2"),
  url("//at.alicdn.com/wf/webfont/h2kiuecLB7qy/car6RTxEvM9j.woff") format("woff");
  font-display: swap;
}
...
@font-face {
  ...
  font-weight: 400;
  src: url("//at.alicdn.com/wf/webfont/h2kiuecLB7qy/K9Kjd77QQbWo.woff2") format("woff2"),
  url("//at.alicdn.com/wf/webfont/h2kiuecLB7qy/EPdlbJ3h65JL.woff") format("woff");
  font-display: swap;
}
/* 在线链接服务仅供平台体验和调试使用，平台不承诺服务的稳定性，企业客户需下载字体包自行发布使用并做好备份。 */
/* 在线链接服务仅供平台体验和调试使用，平台不承诺服务的稳定性，企业客户需下载字体包自行发布使用并做好备份。 */
@font-face {
  ...
  font-weight: 400;
  src: url("//at.alicdn.com/wf/webfont/h2kiuecLB7qy/uH4q3x2Sqprg.woff2") format("woff2"),
  url("//at.alicdn.com/wf/webfont/h2kiuecLB7qy/yhSOdPT8dg0k.woff") format("woff");
  font-display: swap;
}
.font1 {
